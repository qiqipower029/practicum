...
CL_quadratic_result$p_adjust = p.adjust(CL_quadratic_result$p.value, method = "hochberg")
BA_quadratic_result$p_adjust = p.adjust(BA_quadratic_result$p.value, method = "hochberg")
PM_quadratic_result$p_adjust = p.adjust(PM_quadratic_result$p.value, method = "hochberg")
OL_quadratic_result$p_adjust = p.adjust(OL_quadratic_result$p.value, method = "hochberg")
```

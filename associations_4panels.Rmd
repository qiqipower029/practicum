...
for (i in 1:481) {
  CL_converted[i] = CL_new[i+10]> CL_quantile[i]
}
...
for (i in 1:256) {
  BA_converted[i] = BA_new[i+10]> BA_quantile[i]
}
...
for (i in 1:183) {
  PM_converted[i] =PM_new[i+10]> PM_quantile[i]
}
...
for (i in 1:71) {
  OL_converted[i] = OL_new[i+10]> OL_quantile[i]
}

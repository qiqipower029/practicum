...
variable_xgb = data.frame(matrix(ncol = 2, nrow = 481))
colnames(variable_xgb) = c("variable_names", "sum_gain")
variable_xgb$variable_names = variable[2:482]
variable_xgb$sum_gain = 0
